...
# sample_selfies_list = [
# [ 1, "http://placehold.it/427x640/884165/ffffff", "I've itching on my chin"],
# [ 2, "http://placehold.it/864x1152/fec16d/ffffff", ""],
# [ 3, "http://placehold.it/480x640/fede86/ffffff", "I've dry skin, but I'm sweating a lot these days"],
# [ 4, "http://placehold.it/960x960/fddd9d/ffffff", "My face is always oily"],
# [ 5, "http://placehold.it/670x846/ec696d/ffffff", "My arms are red"],
# [ 6, "mobile_bg.jpg", "What is wrong with my hairline. Why is it receding?"]
# ]

# sample_selfies_list.each do |pid, image, desc|
#   SelfieForm.create( patient_id: pid, image: image, desc: desc, doctor_id: 1)
#   i += 1
# end
